...
public interface LivrosRepository //nome da classe seguindo a convenção de nomenclatura para repositórios
...
<Livros, Long> { // colocamos o nosso modelo de dados (User) e o tipo do ID (Long) para que o Spring Data JPA possa gerar a implementação correta dos métodos de acesso a dados
